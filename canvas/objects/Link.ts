...
const Link = fabric.util.createClass(fabric.Line, {
	...
	setPort(fromNode: NodeObject | any, fromPort: PortObject | any, _toNode: NodeObject, toPort: PortObject | any) {
	...
	setPortEnabled(node: NodeObject | any, port: PortObject | any, enabled: boolean) {
