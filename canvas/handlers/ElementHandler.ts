...
class ElementHandler {
     ...
     * @returns
     */
    public setPosition = (el: HTMLElement, obj: any) => {
        if (!el) {
            return;
        }
        obj.setCoords();
    ...
    public setPositionByOrigin = (el: HTMLElement, obj: any, left: number, top: number) => {
        if (!el) {
            return;
        }
        obj.setCoords();
     ...
     * @returns
     */
    public setScaleOrAngle = (el: HTMLElement, obj: any) => {
        if (!el) {
            return;
        }
        const zoom = this.handler.canvas.getZoom();
