...
class GuidelineHandler {
	handler: any;
	verticalLines: { x?: number; y1?: number; y2?: number }[] | any;
	horizontalLines: { y?: number; x1?: number; x2?: number }[] | any;
	ctx: CanvasRenderingContext2D | any;
	viewportTransform: number[] | any;
	...
	drawVerticalLine = (coords: { x?: number; y1?: number; y2?: number } | any) => {
		this.drawLine(
			coords.x + 0.5,
	...
	drawHorizontalLine = (coords: { y?: number; x1?: number; x2?: number } | any) => {
		this.drawLine(
