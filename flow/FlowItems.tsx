...
class FlowItems extends Component<IProps> {
	item: any;
	attachEventListener = (canvasRef: any) => {
	...
	detachEventListener = (canvasRef: any) => {
	...
	render() {
		return (
			<div className="flow-editor-items">
				<Collapse defaultActiveKey={Object.keys(Descriptors as any)}>
					{Object.keys(Descriptors).map((key: any) => (
